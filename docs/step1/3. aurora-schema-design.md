...
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#cfe2ff', 'primaryTextColor':'#212529', 'primaryBorderColor':'#0d6efd', 'lineColor':'#0d6efd', 'secondaryColor':'#cfe2ff', 'tertiaryColor':'#cfe2ff', 'background':'#ffffff', 'mainBkgColor':'#cfe2ff', 'secondBkgColor':'#cfe2ff', 'tertiaryBkgColor':'#cfe2ff', 'noteBkgColor':'#cfe2ff', 'noteTextColor':'#212529', 'noteBorderColor':'#0d6efd', 'actorBorder':'#0d6efd', 'actorBkg':'#cfe2ff', 'actorTextColor':'#212529', 'actorLineColor':'#0d6efd', 'cScale0':'#cfe2ff', 'cScale1':'#cfe2ff', 'cScale2':'#cfe2ff', 'cScaleLabel':'#212529', 'cScaleLabelText':'#212529', 'pie1':'#cfe2ff', 'pie2':'#cfe2ff', 'pie3':'#cfe2ff', 'pie4':'#cfe2ff', 'pie5':'#cfe2ff', 'pie6':'#cfe2ff', 'pie7':'#cfe2ff'}}}%%
erDiagram
    PROVIDERS ||--o{ USERS : "has"
    USERS ||--o{ ARCHIVES : "has"
    USERS ||--o{ REFRESH_TOKENS : "has"
    USERS ||--o{ USER_HISTORY : "tracks"
    USERS ||--o{ CONVERSATION_SESSIONS : "has"
    ADMINS ||--o{ ADMIN_HISTORY : "tracks"
    ARCHIVES ||--o{ ARCHIVE_HISTORY : "tracks"
    CONVERSATION_SESSIONS ||--o{ CONVERSATION_MESSAGES : "has"
    
    PROVIDERS {
        BIGINT_UNSIGNED id PK "TSID"
        VARCHAR_50 name UK
    ...
    ADMIN_HISTORY {
        BIGINT_UNSIGNED history_id PK "TSID"
    ...
    CONVERSATION_SESSIONS {
        BIGINT_UNSIGNED session_id PK "TSID"
        BIGINT_UNSIGNED user_id FK
        VARCHAR_200 title
    ...
    CONVERSATION_MESSAGES {
        BIGINT_UNSIGNED message_id PK "TSID"
...
4. **USERS → USER_HISTORY**: One-to-Many (한 사용자는 여러 변경 이력을 가질 수 있음, tracks 관계)
5. **USERS → CONVERSATION_SESSIONS**: One-to-Many (한 사용자는 여러 대화 세션을 가질 수 있음)
6. **ADMINS → ADMIN_HISTORY**: One-to-Many (한 관리자는 여러 변경 이력을 가질 수 있음, tracks 관계)
7. **ARCHIVES → ARCHIVE_HISTORY**: One-to-Many (한 아카이브는 여러 변경 이력을 가질 수 있음, tracks 관계)
