...
# 순차 실행 
- 다음의 주제로 7000자 이상 분량의 기술 블로그 글을 작성하기 위한 프롬프트를 작성합니다. 

- 그 후, 작성된 프롬프트를 실행해 블로그 글을 작성합니다. 

# 주제 : {주제}

# 프롬프트에서 지시해야 할 필수 항목: 
1. 글의 톤과 문체를 다음의 블로그 글과 일관되도록 지시하는 프롬프트를 작성합니다. -ㅂ니다. 톤으로 통일하도록 프롬프트를 작성합니다.
...
# 순차 실행 리마인드 
- 적절한 프롬프트 엔지니어링 기법을 사용해 이상의 요청사항을 충족하는 기술 블로그 글 작성을 요청하는 프롬프트를 작성하세요.

- 그리고 그 프롬프트를 실행해 기술 블로그 글을 작성하세요.