package com.tech.n.ai.datasource.mariadb.repository.reader.archive;
 ...
 */
@Repository
public interface ArchiveReaderRepository extends JpaRepository<ArchiveEntity, Long>, JpaSpecificationExecutor<ArchiveEntity> {
