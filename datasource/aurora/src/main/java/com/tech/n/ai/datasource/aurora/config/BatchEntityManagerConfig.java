...
@EntityScan(basePackages = {
    "com.tech.n.ai.datasource.aurora.entity"
})
...
public class BatchEntityManagerConfig {
    ...
    public LocalContainerEntityManagerFactoryBean primaryEMF() {
        ...
        em.setPersistenceUnitName("batch-writer");
    ...
    public Properties setProperties(Properties properties, boolean isAutoCommit) {
        ...
        properties.setProperty("spring.jpa.database-platform", env.getProperty("spring.jpa.batch.database-platform"));
        ...
        properties.setProperty("hibernate.dialect", env.getProperty("spring.jpa.batch.database-platform"));
