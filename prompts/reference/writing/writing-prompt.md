당신은 자바 개발자입니다. 다음의 주제로 5000자 이상 분량의 블로그 글을 작성하기 위한 프롬프트를 작성합니다. 

# 대상 모듈 : '/Users/r00442/Documents/workspace/shrimp-tm-demo/api/agent'

# 대상 설계서 : '/Users/r00442/Documents/workspace/shrimp-tm-demo/docs/reference/automation-pipeline-to-ai-agent/*'

# 주제 : 
Langchain4j MessageWindowChatMemory 의 설계 의도 이해 2: Tool 기반 AI Agent 구현 시 메모리 방식으로 사용하면 얻을 수 있는 이점 - 일반 (또는 RAG 기반) 챗봇의 메모리 방식(ex - MongoDBChatMemoryStore) 과 비교를 중심으로
