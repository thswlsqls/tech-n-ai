...
Common 모듈(common-core, common-exception, common-security, common-kafka)을 구현하여 프로젝트 전반에서 사용할 공통 기능을 제공합니다.
...
### 프롬프트
- 메인 프롬프트(`prompts/shrimp-task-prompt.md`)의 3단계 섹션 참고
