package com.tech.n.ai.batch.source.domain.contest.devpost.reader;
...
@Slf4j
public class DevpostScrapingItemReader<T> extends AbstractPagingItemReader<T> {

    protected ContestDevpostScraperService service;
    protected List<ScrapedContestItem> allItems;
    protected int currentIndex = 0;

    public DevpostScrapingItemReader(int pageSize, ContestDevpostScraperService service) {
