package com.tech.n.ai.batch.source.domain.contest.devpost.listener;
...
public class DevpostJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://devpost.com";
    private static final String SOURCE_CATEGORY = "개발자 대회 정보";
    public static final String SOURCE_ID_KEY = "devpost.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("Devpost job completed with status: {}", jobExecution.getStatus());
    }
