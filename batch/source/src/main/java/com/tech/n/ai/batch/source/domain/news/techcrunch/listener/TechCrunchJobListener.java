package com.tech.n.ai.batch.source.domain.news.techcrunch.listener;
...
public class TechCrunchJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://techcrunch.com";
    private static final String SOURCE_CATEGORY = "최신 IT 테크 뉴스 정보";
    public static final String SOURCE_ID_KEY = "techcrunch.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("TechCrunch job completed with status: {}", jobExecution.getStatus());
    }
