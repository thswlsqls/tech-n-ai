package com.tech.n.ai.batch.source.domain.news.googledevelopers.reader;
...
@Slf4j
public class GoogleDevelopersRssItemReader<T> extends AbstractPagingItemReader<T> {

    protected NewsGoogleDevelopersRssService service;
    protected List<RssFeedItem> allItems;
    protected int currentIndex = 0;

    public GoogleDevelopersRssItemReader(int pageSize, NewsGoogleDevelopersRssService service) {
