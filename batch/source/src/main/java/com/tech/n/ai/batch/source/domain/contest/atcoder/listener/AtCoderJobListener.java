package com.tech.n.ai.batch.source.domain.contest.atcoder.listener;
...
public class AtCoderJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://atcoder.jp";
    private static final String SOURCE_CATEGORY = "개발자 대회 정보";
    public static final String SOURCE_ID_KEY = "atcoder.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("AtCoder job completed with status: {}", jobExecution.getStatus());
    }
