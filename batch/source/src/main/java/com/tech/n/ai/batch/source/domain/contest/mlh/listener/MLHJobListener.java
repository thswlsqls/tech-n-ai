package com.tech.n.ai.batch.source.domain.contest.mlh.listener;
...
public class MLHJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://mlh.io";
    private static final String SOURCE_CATEGORY = "개발자 대회 정보";
    public static final String SOURCE_ID_KEY = "mlh.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("MLH job completed with status: {}", jobExecution.getStatus());
    }
