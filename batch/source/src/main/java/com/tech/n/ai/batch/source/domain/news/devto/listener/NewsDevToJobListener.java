package com.tech.n.ai.batch.source.domain.news.devto.listener;
...
public class NewsDevToJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://dev.to";
    private static final String SOURCE_CATEGORY = "최신 IT 테크 뉴스 정보";
    public static final String SOURCE_ID_KEY = "news.devto.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("DevTo(News) job completed with status: {}", jobExecution.getStatus());
    }
