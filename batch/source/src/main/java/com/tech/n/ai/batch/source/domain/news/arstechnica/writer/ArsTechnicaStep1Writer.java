package com.tech.n.ai.batch.source.domain.news.arstechnica.writer;
...
/**
 * Ars Technica Step1 Writer
 * batch-source DTO → client-feign DTO 변환 후 내부 API 호출
 */
@Slf4j
@StepScope
@RequiredArgsConstructor
public class ArsTechnicaStep1Writer implements ItemWriter<NewsCreateRequest> {
