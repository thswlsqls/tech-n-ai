package com.tech.n.ai.batch.source.domain.news.googledevelopers.listener;
...
public class GoogleDevelopersJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://developers.googleblog.com";
    private static final String SOURCE_CATEGORY = "최신 IT 테크 뉴스 정보";
    public static final String SOURCE_ID_KEY = "googledevelopers.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("Google Developers job completed with status: {}", jobExecution.getStatus());
    }
