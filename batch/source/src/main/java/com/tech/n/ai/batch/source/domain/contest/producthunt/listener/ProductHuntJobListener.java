package com.tech.n.ai.batch.source.domain.contest.producthunt.listener;
...
public class ProductHuntJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://www.producthunt.com";
    private static final String SOURCE_CATEGORY = "개발자 대회 정보";
    public static final String SOURCE_ID_KEY = "producthunt.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("ProductHunt job completed with status: {}", jobExecution.getStatus());
    }
