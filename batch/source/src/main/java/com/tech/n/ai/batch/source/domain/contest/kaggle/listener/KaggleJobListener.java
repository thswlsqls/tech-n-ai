package com.tech.n.ai.batch.source.domain.contest.kaggle.listener;
...
public class KaggleJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://www.kaggle.com";
    private static final String SOURCE_CATEGORY = "개발자 대회 정보";
    public static final String SOURCE_ID_KEY = "kaggle.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("Kaggle job completed with status: {}", jobExecution.getStatus());
    }
