package com.tech.n.ai.batch.source.domain.contest.gsoc.reader;
...
@Slf4j
public class GSOCScrapingItemReader<T> extends AbstractPagingItemReader<T> {

    protected ContestGSOCScraperService service;
    protected List<ScrapedContestItem> allItems;
    protected int currentIndex = 0;

    public GSOCScrapingItemReader(int pageSize, ContestGSOCScraperService service) {
