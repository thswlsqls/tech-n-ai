package com.tech.n.ai.batch.source.domain.contest.hackernews.writer;
...
/**
 * HackerNews Step1 Writer
 * batch-source DTO → client-feign DTO 변환 후 내부 API 호출
 */
@Slf4j
@StepScope
@RequiredArgsConstructor
public class HackerNewsStep1Writer implements ItemWriter<ContestCreateRequest> {
