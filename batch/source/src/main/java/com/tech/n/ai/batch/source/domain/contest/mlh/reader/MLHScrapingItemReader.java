package com.tech.n.ai.batch.source.domain.contest.mlh.reader;
...
@Slf4j
public class MLHScrapingItemReader<T> extends AbstractPagingItemReader<T> {

    protected ContestMLHScraperService service;
    protected List<ScrapedContestItem> allItems;
    protected int currentIndex = 0;

    public MLHScrapingItemReader(int pageSize, ContestMLHScraperService service) {
