package com.tech.n.ai.batch.source.domain.news.hackernews.reader;
...
@Slf4j
public class NewsHackerNewsApiPagingItemReader<T> extends AbstractPagingItemReader<T> {

    protected NewsHackerNewsApiService service;
    protected Integer limit;

    public NewsHackerNewsApiPagingItemReader(int pageSize
                                            , NewsHackerNewsApiService service
                                            , Integer limit) {
