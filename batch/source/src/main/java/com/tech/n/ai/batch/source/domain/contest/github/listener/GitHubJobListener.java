package com.tech.n.ai.batch.source.domain.contest.github.listener;
...
public class GitHubJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://github.com";
    private static final String SOURCE_CATEGORY = "개발자 대회 정보";
    public static final String SOURCE_ID_KEY = "github.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("GitHub job completed with status: {}", jobExecution.getStatus());
    }
