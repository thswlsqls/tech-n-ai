package com.tech.n.ai.batch.source.domain.news.hackernews.listener;
...
public class NewsHackerNewsJobListener implements JobExecutionListener {
    ...
    public static final String SOURCE_ID_KEY = "news.hackernews.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("HackerNews(News) job completed with status: {}", jobExecution.getStatus());
    }
