package com.tech.n.ai.batch.source.domain.contest.leetcode.listener;
...
public class LeetCodeJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://leetcode.com";
    private static final String SOURCE_CATEGORY = "개발자 대회 정보";
    public static final String SOURCE_ID_KEY = "leetcode.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("LeetCode job completed with status: {}", jobExecution.getStatus());
    }
