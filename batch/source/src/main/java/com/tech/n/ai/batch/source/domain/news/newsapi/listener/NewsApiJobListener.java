package com.tech.n.ai.batch.source.domain.news.newsapi.listener;
...
public class NewsApiJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://newsapi.org";
    private static final String SOURCE_CATEGORY = "최신 IT 테크 뉴스 정보";
    public static final String SOURCE_ID_KEY = "newsapi.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("NewsAPI job completed with status: {}", jobExecution.getStatus());
    }
