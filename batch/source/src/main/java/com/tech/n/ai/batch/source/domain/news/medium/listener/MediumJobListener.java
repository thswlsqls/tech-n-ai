package com.tech.n.ai.batch.source.domain.news.medium.listener;
...
public class MediumJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://medium.com";
    private static final String SOURCE_CATEGORY = "최신 IT 테크 뉴스 정보";
    public static final String SOURCE_ID_KEY = "medium.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("Medium job completed with status: {}", jobExecution.getStatus());
    }
