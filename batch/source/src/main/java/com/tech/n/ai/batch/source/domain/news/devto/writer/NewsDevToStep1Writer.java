package com.tech.n.ai.batch.source.domain.news.devto.writer;
...
/**
 * DevTo Step1 Writer (News)
 * batch-source DTO → client-feign DTO 변환 후 내부 API 호출
 */
@Slf4j
@StepScope
@RequiredArgsConstructor
public class NewsDevToStep1Writer implements ItemWriter<NewsCreateRequest> {
