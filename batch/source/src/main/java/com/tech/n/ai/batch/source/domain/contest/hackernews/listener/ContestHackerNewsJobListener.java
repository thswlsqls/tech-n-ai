package com.tech.n.ai.batch.source.domain.contest.hackernews.listener;
...
public class ContestHackerNewsJobListener implements JobExecutionListener {

    private static final String SOURCE_URL = "https://news.ycombinator.com";
    private static final String SOURCE_CATEGORY = "개발자 대회 정보";
    public static final String SOURCE_ID_KEY = "contest.hackernews.sourceId";
    ...
    public void afterJob(JobExecution jobExecution) {
        log.info("HackerNews(Contest) job completed with status: {}", jobExecution.getStatus());
    }
