package com.tech.n.ai.api.aiupdate.common;
...
public class SlackNotifier {
     ...
     * 승인 알림 전송
     */
    public void sendApprovalNotification(AiUpdateDetailResponse update) {
     ...
     * 거부 알림 전송
     */
    public void sendRejectionNotification(AiUpdateDetailResponse update) {
